          ...
          <div class="FotoDiv">
              <?php
                ...
                foreach($conn->query($sql, PDO::FETCH_ASSOC) as $row){
                  ...
                  echo "<img class='Foto' style='background-image: url($naam_image)'>";
                }
              ?>
      ...
      <div class="googleMaps">
        ...
        require('./components/dbconn.php');
            try {
				...
				$address = $row["adres"];
				echo '<iframe class="Frame" frameborder="0" src="https://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q=' . str_replace(",", "", str_replace(" ", "+", $address)) . '&z=14&output=embed"></iframe>';
            }
            catch(PDOException $e) {
                echo "Error: " . $e->getMessage();
            }
