        ...
        <div class="content-mailsysteem">
            <table class="mails">
                <tr>
                    <th>voornaam</th>
                    <th>achternaam</th>
                    <th style="width: 175px;">e-mail adres</th>
                    <th style="width: 200px; word-break: break-word;">het bericht</th>
                    <th>gereageerd</th>
                    <th>Reageer!</th>
                </tr>
                ...
                <?php
                        ...
                        foreach($conn->query($sql, PDO::FETCH_ASSOC) as $row){
                            ...
                            $reabutton = "";
                                ...
                                echo "<td>".$mail."</td>";
                                echo "<td style='word-break: break-word; max-width: 260px; min-width: 260px; text-align: center;'>".$body."</td>";
                                echo "<td>".$gereageerd."</td>";
                                if ($gereageerd == 0){
                                    ?><td><a
                        href='https://fresh-dev.academy/ivar-wouter/mailsysteem.php?id=<?= $id;?>'>Reageer</a></td>
                <?php
                                }
    ...
    if (isset($_POST['mail'])) {
     ...
     require('./components/dbconn.php');
        ...
        //Send mail
         ...
         $mail->addReplyTo('wouter@wilmink.com');
