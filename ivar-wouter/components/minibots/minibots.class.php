...
Class Minibots 
{
	...
	*/
	public function doSpelling($q) {
		...
		for($j=0;$j<count($a_array[0]);$j++) {
			...
			if(stristr($a_array[0][$j],"spell=1&amp")) return strip_tags($a_array[0][$j]);
	...
	*/
	public function getLatLong($address){
		$_url = "https://geocode.xyz/".rawurlencode($address)."?geoit=xml";
	...
	*/
	public function ipToGeo($ip="") {
		if(!$ip) $ip = $this->getIP();
		$ar = file_get_contents("http://api.ipstack.com/".$ip."?access_key=d0c96b23d527c1001d645b28c2cf6988");
